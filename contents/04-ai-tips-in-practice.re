...
@<b>{Lemio}：@<em>{テキスト検索だと言葉に言語化しなければなりませんが、音声なら擬音語やオノマトペを使って、ふわっとした形から絞り込んでいくことができます。昔見たYouTubeの動画で、タイトルが全然わからなくても、「こういう感じのやつ」と探していったら出てきたりするんですよ。}

@<b>{Kuu}：@<em>{それは面白いですね。正確なキーワードを知らなくても検索が成立するのは大きい。}
...
@<b>{Lemio}：@<em>{「あれは使えなかった」という記憶を定期的にリセットした方がいい。定期的に触り直す「健康診断」みたいな習慣が大事ですね。}
...
@<b>{Sae}：@<em>{無料枠で判断する人が多いですが、有料プランでないと見えない世界がある。ハッカソンに出るなら、1ヶ月だけでも有料プランを試してみてほしいです。}
