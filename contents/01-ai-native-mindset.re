...
具体的なガードレールには、Agent Skillsの整備、使用するAPIの情報整理、プロジェクトのルール文書化などがある。Agent Skillsとは、プロジェクトのルートなどに配置するMarkdownファイルで、AIが従うべきルールや参照すべき情報を定義する仕組みだ。たとえば開発規約やAPI仕様をスキルファイルに記述しておけば、AIはプロジェクト固有のルールに沿ったコードを生成できる。
