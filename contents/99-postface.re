...
ハッカソンは、その衝動をそのまま発揮できる場です。作って、壊して、また作り直せるプレイグラウンド（遊び場）。締め切りがあり、仲間がいて、発表の場がある。この三要素が揃うことで、普段は「いつかやろう」と先延ばしにしているアイデアが、具体的なプロダクトとして世に出ます。失敗しても失うものはなく、新しい技術を気軽に試せます。
